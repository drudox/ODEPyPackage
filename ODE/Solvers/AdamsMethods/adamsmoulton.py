'''
    module containing the adams multon methods (Implicit Predictor Corrector)
...
#----------------------------------------------------------------------------------------------------------
##
##                                 ADAMS MOULTON IMPLICIT SCHEME 
##
#---------------------------------------------------------------------------------------------------------
#                       Adams Moulton N Step (N+1 th order implicit scheme) 
...
class AdamsMoulton5th(AdamsMethods):
        '''
        '''
        #um1,um2,um3,um4 = np.array([0]), np.array([0]), np.array([0]), np.array([0])
        #fst_stup , snd_stup , trd_stup , fth_stup = True,True,True,True 
